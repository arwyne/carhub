...
@section('body')
    ...
    <div class="container">
        ...
        <div class="transactions-edit-container">
            <h2 class="text-center">Transaction Update</h2>
                    ...
                    <form action="/transactions/{{ $reservation->id }}" method="POST">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><input type="date" id="pickup_date" name="pickup_date" value="{{ $reservation->pickup_date }}" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input type="date" id="return_date" name="return_date" value="{{ $reservation->return_date }}" required></td>
                            </tr>
